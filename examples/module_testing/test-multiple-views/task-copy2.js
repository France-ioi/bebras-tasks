(function() {
    ...
    function initTaskShared(subTask) {
        displayHelper.thresholdEasy = 5000;
        displayHelper.thresholdMedium = 10000;
    }

    //initWrapper(initSubTask, levels, defaultLevel, reloadWithCallbacks)
//    initWrapper(initTask, ['easy', 'medium'], null, true);

    initTaskMultipleViews({
        'easy': initTask1,
        'medium': initTask2,
        'hard': [
            initTask1,
